...
class Telegram
{
    ...
    //     // $type = $this->getUpdateType();
    //     // if ($type == self::VOICE) {
    //     //     return $this->data['callback_query']['voice']['file_id'];
    //     // }
    ...
    public function getFileID()
    {
        ...
        if (isset($update['message']['photo'])) {
            return $update['message']['photo'][0]['file_id'];
        }
        if (isset($update['message']['video'])) {
            return $update['message']['video']['file_id'];
        }
        //return '';  file_size  "mime_type":"audio/ogg"  duration getVoiceFileDURATION getVoiceFileMIMETYPE getVoiceFileSIZE
    }
    public function getFileID1()
    {
        $update = $this->data;
        if (isset($update['message']['voice'])) {
            return $update['message']['voice']['file_id'];
    ...
    public function getFileID2()
    {
        ...
        if (isset($update['message']['photo'])) {
            return $update['message']['photo'][2]['file_id'];
        }
        if (isset($update['message']['video'])) {
            return $update['message']['video']['file_id'];
        }
    ...
    public function getVoiceFileDURATION()
    {
        $update = $this->data;
        if (isset($update['message']['voice'])) {
            return $update['message']['voice']['duration'];
        }
    }
    public function getVoiceFileMIMETYPE()
    {
        $update = $this->data;
        if (isset($update['message']['voice'])) {
            return $update['message']['voice']['mime_type'];
        }
    }
    public function getFileSIZE()
    {
        $update = $this->data;
        if (isset($update['message']['voice'])) {
            return $update['message']['voice']['file_size'];
        }
        if (isset($update['message']['photo'])) {
            return $update['message']['photo'][0]['file_size'];
        }
    }
    public function getPhotoWidth2()
    {
        $update = $this->data;
        if (isset($update['message']['photo'])) {
            return $update['message']['photo'][2]['width'];
        }
    }
    public function getPhotoHeight2()
    {
        $update = $this->data;
        if (isset($update['message']['photo'])) {
            return $update['message']['photo'][2]['height'];
        }
    }
